  ...
  return <TooltipProvider delayDuration={300}><div className="flex min-h-0 flex-1 flex-col overflow-hidden">
    ...
    <div className="flex-1 overflow-auto">
      ...
      <section aria-label="Metric results" className="space-y-4 p-4 sm:p-6">
        ...
        {health && !health.ok && <div role="status" className="rounded-lg border border-warning/40 p-3 text-sm"><p className="font-medium">The database connection could not be verified.</p><p className="mt-1 break-words text-muted-foreground">{health.error} Saved definitions remain available. Check the server connection settings or retry.</p></div>}
